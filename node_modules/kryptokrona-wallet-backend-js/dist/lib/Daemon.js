    ...
    makeRequest(endpoint, method, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = yield request(Object.assign(Object.assign(Object.assign({ agent: protocol === 'https' ? this.httpsAgent : this.httpAgent }, options), this.config.customRequestOptions), { url }));
                ...
                Logger_1.logger.log(`Got response from ${url} with body ${JSON.stringify(data)}`, Logger_1.LogLevel.TRACE, [Logger_1.LogCategory.DAEMON]);
                return data;
            }
            catch (err) {
                ...
                try {
                    ...
                    Logger_1.logger.log(`Making request to ${url} with params ${body ? JSON.stringify(body) : '{}'}`, Logger_1.LogLevel.TRACE, [Logger_1.LogCategory.DAEMON]);
                    const data = yield request(Object.assign(Object.assign({ agent: this.httpAgent }, options), { 
                        /* Lets try HTTP now. */
                        url }));
                    this.ssl = false;
                    this.sslDetermined = true;
