...
export declare class SubWallets {
     ...
     * transaction is ours.
     */
    private readonly publicSpendKeys;
    /**
     ...
     */
    static init(config: Config, address: string, scanHeight: number, newWallet: boolean, privateViewKey: string, privateSpendKey?: string): Promise<SubWallets>;
    ...
    markInputAsLocked(publicSpendKey: string, keyImage: string, transactionHash: string): void;
    /**
    ...
    haveSpendableInput(input: TransactionInput, height: number): boolean;
    /**
     ...
     */
    getBalance(currentHeight: number, subWalletsToTakeFrom?: string[]): Promise<[number, number]>;
    /**
     ...
     */
    getSpendableTransactionInputs(subWalletsToTakeFrom: string[], currentHeight: number): Promise<TxInputAndOwner[]>;
    getFusionTransactionInputs(subWalletsToTakeFrom: string[], mixin: number, currentHeight: number): Promise<[TxInputAndOwner[], number]>;
    /**
     ...
     */
    getTransactions(address?: string, includeFusions?: boolean): Promise<Transaction[]>;
    /**
     ...
     * has changed.
     */
    getNumTransactions(address?: string, includeFusions?: boolean): Promise<number>;
    /**
     ...
     */
    getUnconfirmedTransactions(address?: string, includeFusions?: boolean): Promise<Transaction[]>;
    /**
     ...
     * has changed.
     */
    getNumUnconfirmedTransactions(address?: string, includeFusions?: boolean): Promise<number>;
    initAfterLoad(config: Config): void;
    addSubWallet(scanHeight: number): Promise<([string, undefined] | [undefined, WalletError])>;
